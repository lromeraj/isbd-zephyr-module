...
int8_t isbd_set_quiet( bool enable ) {
...
int8_t isbd_get_revision( char *__revision, uint16_t revision_len ) {
  ...
  return _uart_pack_txt_resp( __revision, revision_len, 10, 100 );
}
...
isbd_at_code_t _at_get_str_code( const char *__buff ) {
